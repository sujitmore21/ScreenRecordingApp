package com.sujitmo.screenrecordingapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final long START_TIME_5_SECONDS_IN_MILLIS = 5000;

    private long timeLeftInMillis = START_TIME_5_SECONDS_IN_MILLIS;
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(timeLeftInMillis, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                tvCountDown.setText(String.valueOf(timeLeftInMillis / 1000));
            }
    ...
    private void startMediaRecorder() {
        try {
            strVideoUri = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/SingularityCoder_" + new SimpleDateFormat("dd-MM-yyyy-hh_mm_ss").format(new Date()) + ".mp4";
    ...
    private VirtualDisplay createVirtualDisplay() {
        return mediaProjection.createVirtualDisplay("MainActivity", DEVICE_WIDTH, DEVICE_HEIGHT, screenDensity, DisplayManager.VIRTUAL_DISPLAY_FLAG_AUTO_MIRROR, mediaRecorder.getSurface(), null, null);
    }
